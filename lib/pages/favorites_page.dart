...
class FavoriteModalSheet extends StatefulWidget {
  ...
  @override
  State<FavoriteModalSheet> createState() => _FavoriteModalSheetState();
}

class _FavoriteModalSheetState extends State<FavoriteModalSheet> {
  List<String> tags = [];
...
void showFavoriteModalSheet(BuildContext context) {
  showModalBottomSheet(
    ...
    builder: (BuildContext context) => FavoriteModalSheet(),
  );
}
